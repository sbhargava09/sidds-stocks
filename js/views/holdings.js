...
// Default point count when SPX data unavailable (fallback simulation)
function defaultN(range) {
  return { '1D': 78, '5D': 65, '1M': 22, '6M': 26, 'YTD': 26, '1Y': 52 }[range] || 30;
}

// ── Simulated time labels (fallback only) ────────────────────────────────────
...
// ── Portfolio path: simulated % return curve, pinned to real day gain ────────
